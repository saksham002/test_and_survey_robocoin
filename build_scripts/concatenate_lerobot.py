#!/usr/bin/env python3
"""
Download all RoboCOIN datasets and construct a LeRobotDataset or MultiLeRobotDataset.

This script:
1. Lists all HF datasets with prefix "RoboCOIN/"
2. Downloads them using robocoin-download command
3. Constructs a LeRobotDataset or MultiLeRobotDataset from downloaded datasets
   (use --use_multi flag to force MultiLeRobotDataset)
4. Iterates through the dataset using PyTorch DataLoader
"""
...
def build_multi_dataset(repo_ids: List[str], use_multi: bool = False):
    """
    ...
    # Create image transform: resize to 224x224 and normalize with ImageNet stats
...
def main():
    ...
    dataset = build_multi_dataset(successful_repo_ids, use_multi = args.use_multi)
